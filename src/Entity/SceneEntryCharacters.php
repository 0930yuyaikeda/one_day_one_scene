...
#[ORM\Entity(repositoryClass: SceneEntryCharactersRepository::class)]
class SceneEntryCharacters
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    private ?int $scene_entry_character_id = null;
    ...
    public function getSceneEntryCharacterId(): ?int
    {
        return $this->scene_entry_character_id;
    }
