...
class GuestPoints
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    private ?int $guest_point_id = null;
    ...
    public function getGuestPointId(): ?int
    {
        return $this->guest_point_id;
    }
    ...
    public function getGestPoint(): ?int
    {
        return $this->gest_point;
    }

    public function setGestPoint(int $gest_point): static
    {
        $this->gest_point = $gest_point;
