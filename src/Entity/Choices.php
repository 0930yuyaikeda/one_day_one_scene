...
class Choices
{
    ...
    #[ORM\Column]
    private ?int $choice_selected_number = null;
    ...
    public function getChoiceSelectedNumber(): ?int
    {
        return $this->choice_selected_number;
    }

    public function setChoiceSelectedNumber(int $choice_selected_number): static
    {
        $this->choice_selected_number = $choice_selected_number;
